...
|-----|-----|-----|-----|-----|-----|-----|-----| 
| 01 | model A | Planet 4bands (/10,000) | | | |  ・崩壊地の輪郭を捉えられている <br> ・閾値の調節は必要 | April 17 |
| 02 | model A | Planet 4bands (/10,000) | ・値0-1の確認 <br> ・崩壊地と教えている所が本当に崩壊地か確認 | | | | April 18 |

| filename | precision | recall | f1 | iou |
|-----|-----|-----|-----|-----|
| tile_gofukuya_01792_01024 |	0.9402 | 0.8490 | 0.8923 | 0.8056 |
